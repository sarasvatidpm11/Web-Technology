...
<header class="bg-transparent top-0 left-0 w-full flex items-center z-10">
            <div class="container">
                <div class="flex items-center justify-between relative">
                    <div class="px-4">
                        <a href="#Home" class="font-bold text-2xl text block py-6 text-sky-600 lg:text-3xl">Kecak Here</a>
                    </div>
                    <div class="flex items-center px-4">
                        ...
                        <nav id="nav-menu" class="hidden absolute py-5 rounded-xl bg-white shadow-xl max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                            <ul class= "block lg:flex">
                                <li class="group">
                                    <a href="#Home" class="text-base font-semibold text-zinc-900 py-2 mx-8 flex group-hover:text-sky-600">Dashboard</a>
                                </li >
                                <li class="group">
                                    <a href="Profile.html" class="text-base font-semibold text-zinc-900 py-2 mx-8 flex group-hover:text-sky-600">Promo</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
