                        ...
                        <section>
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src={{asset('img/Kecak.jpg')}} alt="" class=" w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
                                </div>
                                <form class="p-6">
                            ...
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src={{asset('img/Kecak1.jpg')}} alt="" class=" w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
                                </div>
                                <form class="p-6">
                                    <div class="flex flex-wrap">
                                        <h1 class="flex-auto font-medium text-slate-900">
